...
import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Checkbox, Stack, Textarea } from '@chakra-ui/react';
        ...
        <>
            <Grid templateRows='repeat(1, 1fr)' templateColumns='repeat(2, 1fr)'>
                {items.map(item => (
                    <Fragment>
                        <GridItem p={'5'}>
                            <Image boxSize={'600px'} objectFit='cover' src={item.photo} borderWidth='2px' borderRadius='lg' alt={item.imagealt} />
                        </GridItem>

                        <GridItem p={'5'}>
                            <Badge borderRadius='full' px='2' colorScheme='teal'>To {item.giveaway}</Badge>
                            <Heading fontWeight='semibold' as='h4' lineHeight='tight' isTruncated>{item.itemname} </Heading>
                                        ...
                                        {user.userid === item.itemowner | user.userrole === 'admin' ? (
                                            <>
                                                <GridItem >
                                                    <VStack>
                                                        <AccordionItem>
                                                            <AccordionButton><Heading>Update listing</Heading><AccordionIcon /></AccordionButton>
                                                            <AccordionPanel>
                                                ...
                                                <GridItem>
                                                    <Box textAlign="center">
                                                        <AccordionItem>
                                                            <AccordionButton><Heading>Delete listing?</Heading><AccordionIcon /></AccordionButton>
                                                            <AccordionPanel pb={4}>

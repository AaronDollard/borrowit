                                ...
                                <Fragment>
                                    <GridItem p={1} m={1} key={item.id} mt={{ base: 5, md: 0 }} borderWidth='1px' borderRadius='lg' overflow='hidden'>
                                        <Link style={{ textDecoration: 'none' }} href={'/browse/' + item.id}>
                                            <Image borderRadius='lg' h={'150px'} width={'100%'} objectFit='cover' src={item.photo} alt={item.imagealt} />
                                            <Box padding={"10px"}>
                            ...
                            {outgoingOffers.map(item => (
                                <Fragment>
                                    {item.offerstatus === "PENDING" && (
                                        <Box p={1} m={1} key={item.id} mt={{ base: 5, md: 0 }} ml={{ md: 6 }} borderWidth='1px' borderRadius='lg' overflow='hidden'>
                                            <Box>
                                                <Image borderRadius='lg' h={'150px'} width={'100%'} objectFit='cover' src={item.photo} alt={item.imagealt} />
